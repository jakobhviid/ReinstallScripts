...
scoop install busybox curl grep nano vim make say tar sudo micro coreutils git tidy oraclejre8 vlc 7zip paint.net gitkraken filezilla sqlitebrowser putty anaconda3 nodejs python go sharpkeys nssm draw.io ssh-copy-id perl terminus plex-player latex speedtest-cli win-acme
